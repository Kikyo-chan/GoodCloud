...
- 通过answers.cfg做集群安装配置
  ...
  CONFIG_NTP_SERVERS=s2a.time.edu.cn,s2b.time.edu.cn
  ...
  CONFIG_CONTROLLER_HOST=192.168.6.1

  # List the servers on which to install the Compute service.
  CONFIG_COMPUTE_HOSTS=192.168.6.1,192.168.6.2,192.168.6.3
  ...
  CONFIG_NETWORK_HOSTS=192.168.6.1
  ...
  CONFIG_STORAGE_HOST=192.168.1.31

  # (Unsupported!) Server on which to install OpenStack services
  # specific to OpenStack Data Processing (sahara).
  CONFIG_SAHARA_HOST=192.168.1.31
  ...
  CONFIG_KEYSTONE_ADMIN_TOKEN=97b160b227f94b5a9e2bd952f13b675d
  ...
  CONFIG_KEYSTONE_ADMIN_PW=1bfcb04fce2f49f0

  # Password to use for the Identity service 'demo' user.
  CONFIG_KEYSTONE_DEMO_PW=a8c2d523ca02441a
  ...
  CONFIG_KEYSTONE_LDAP_URL=ldap://192.168.1.31
  ...
  # database.
  CONFIG_GLANCE_DB_PW=8f48c1bfef0e420d

  # Password to use for the Image service to authenticate with the
  # Identity service.
  CONFIG_GLANCE_KS_PW=619f021e59264d5d
  ...
  # database.
  CONFIG_NOVA_DB_PW=fafccfc983ac4a74

  # Password to use for the Compute service to authenticate with the
  # Identity service.
  CONFIG_NOVA_KS_PW=f97bd179cb1b4a5f
  ...
  CONFIG_NEUTRON_KS_PW=7460129cd71b489d

  # The password to use for OpenStack Networking to access the
  # database.
  CONFIG_NEUTRON_DB_PW=89fa884e90954a6c
  ...
  CONFIG_NEUTRON_METADATA_PW=7bcdfb8057454b41
  ...
  # =br-ex:eth0
  CONFIG_NEUTRON_OVS_BRIDGE_IFACES=br-ex:eno2
  ...
  CONFIG_HORIZON_SECRET_KEY=a8173461a7ed484ea53e640ed277c0be
  ...
  CONFIG_SWIFT_HASH=01d9aa7c292841f8
  ...
  CONFIG_HEAT_AUTH_ENC_KEY=82738e41f02c4caf
  ...
  # Identity service.
  CONFIG_AODH_KS_PW=e48db7437b954637

  # Password to use for Telemetry Alarming (AODH) to access the
  # database.
  CONFIG_AODH_DB_PW=da7c3cfc87f64f0a
